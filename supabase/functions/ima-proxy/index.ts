...
const DEFENSE_STRONG_RE = /(自恋|撩妹|海王|油嘴|渣|套路深|经常这样|对多少女生|你帮我|你证明|你凭什么|凭什么听|给我发|必须听|我才不去|我不是随便|别想|想得美|谁要跟你|你该不会|前男友|追求者|别人追|有个男生|他在追|你经验很丰富|呵呵哒|无语|服了|就这|有病|滚|闭嘴|拉黑|嫌你|配不上|看不上|幼稚|装什么|装|PUA)/;
...
function buildSystemContent(opts: {
  ...
  s += `\n\n【自洽与输出要求】（严格遵守）\n`
    ...
    + `- 硬字数：整条 ≤20 字，通常 1 句；超过 20 字 = 失败，压缩重写后再输出。\n`
